...
class WorkerProfileComponent extends Component {
  ...
  render() {
    return (
      // <Container style={{ backgroundColor: "#f5f5f5", marginTop: 50 }}>
        <Row style = {{marginTop: 50 , fontFamily: "Josefin Sans"}}>
          <Col xs="6" sm="6">
          <Container style={{ backgroundColor: "#f5f5f5" , marginLeft : 50}}>
